...
class TimelineUnifiedRenderer {
    ...
    renderWeekendBackgroundLayer(startDate, endDate) {
        // Wochenend-Hintergründe auf separatem Background-Canvas (z-index: 1)
        ...
        this.backgroundCtx.rect(this.sidebarWidth, 0, this.backgroundCanvas.width - this.sidebarWidth, this.backgroundCanvas.height);
        ...
        while (currentDate <= endDate) {
            ...
            if (dayOfWeek === 0 || dayOfWeek === 6) {
                ...
                this.backgroundCtx.fillStyle = 'rgba(255, 200, 200, 0.12)'; // Etwas stärker da separater Layer
                this.backgroundCtx.fillRect(x, 0, DAY_WIDTH, this.backgroundCanvas.height);
            }
        ...
        this.backgroundCtx.restore(); // CLIPPING beenden
    }    renderSidebar() {
        // Sidebar-Hintergrund
